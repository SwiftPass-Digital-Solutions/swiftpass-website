export default function Benefit() {
    const benefits = [
        {
            caption: "Save time during onboarding",
            image:  "time.svg",
            backgroundColor: "#FFFCF0",
            borderColor: "#FFE994"
        },
        {
            caption: "Ensure privacy and control over sensitive data",
            image:  "privacy.svg",
            backgroundColor: "#F0F6FF",
            borderColor: "#94BFFF"
        },
        {
            caption: "Zero redundancy across apps",
            image: "smartphone.svg",
            backgroundColor: "#F3F0FF",
            borderColor: "#A994FF"
        },
        {
            caption: "Peace of mind with secure centralized KYC",
            image: "lock.svg",
